...
Classes etc in C# go into _namespaces_ rather than packages like in Java.  They're pretty much the same concept, just with a different name.  You need to wrap your code in a namespace` block, like so:
```cs
